      ...
      <SectionHeader
        ...
        action={
          <div className="flex flex-row flex-wrap justify-end items-start gap-2 relative z-[2000]">
            ...
            <div className="relative w-fit min-w-[120px]">
              <button type="button" className="flex items-center justify-between gap-2 px-3 py-2 bg-clay-surface rounded-[24px] shadow-clay-card focus:outline-none w-full hover:shadow-clay-hover transition-shadow" onClick={() => setShowTypeFilter(!showTypeFilter)}>
                <span className="text-[10px] font-bold uppercase tracking-widest text-clay-secondary flex items-center gap-2">
                  Type 
                  <span className="bg-primary/10 text-primary px-2 py-0.5 rounded-full capitalize">
